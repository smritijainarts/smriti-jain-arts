...
const LOCAL_PRODUCTS = [
  ...
  { id: "005", name: "Clutcher Holder", category: "Home Organizers", price: "₹500", description: "Handmade crochet clutcher holder", detailedDescription: "A practical hand-crocheted clutcher holder in soft pink, designed as a long hanging organizer with plenty of space to display and store hair claws and clips. Finished with a wooden hanging ring, floral accents and a tasselled end, it keeps accessories visible, tidy and easy to reach while doubling as charming wall décor.", image: "images/005-clutcher-holder/005-clutcher-holder-1.jpeg" },
